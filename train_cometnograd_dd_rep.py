...
from data import emotions, read_comet_dd_rep_split, CometEmotionDataset
...
def main():
    ...
    training_args = TrainingArguments(
        output_dir='./results_cometnograd_dd_rep',
        num_train_epochs=10,
        ...
        max_grad_norm=0.0,
        warmup_steps=1634,
        logging_dir='./logs_cometnograd_dd_rep',
    ...
    trainer.save_model('./robertacometnograd_dd_rep')
